...
$(document).ready(function () {
    ...
    $('#section-brake, #section-parachoque, #section-motor, #section-capo, #section-buzina, #section-interior, #section-farol, #section-blindagem, #section-custompneu, #section-pneus, #section-paralama, #section-escape, #section-spoiler, #section-extras').click(function () {
        ...
        `);
            ...
            xenonColours.map(
                (v, k) =>
                    (shopContentHtml += `
        <div class="box ${
                        bennysVehModifications.xenonColor == k ? "forceactive" : ""
            ...
            bennysPaintTypes.map((v, k) => {
                paintTypes += `<div class="box" ${
                    (bennysVehModifications.primaryPaintType == k &&
                        'class="forceactive"') ||
                    ""
                } onclick="setVehPaintType(${k},1,this)">${v}</div>`;
            });
